...
*** I have not fully backtested the code in Quantconnect yet, but do hope to do so at some point soon. Additionally, I'll make a change in the original code by switching from an equally-weighted portfolio to a score weighted portfolio. This is done to ensure the portfolio mimics appropriately its style propensity.
